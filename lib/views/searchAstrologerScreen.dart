...
class SearchAstrologerScreen extends StatelessWidget {
  ...
  SearchController1 searchControllerr = Get.find<SearchController1>();
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () {
              SearchController1 searchController =
          ...
          title: GetBuilder<SearchController1>(builder: (searchController) {
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GetBuilder<SearchController1>(builder: (c) {
