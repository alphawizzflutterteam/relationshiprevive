...
Map<int, Color> color2 = {
  50: const Color.fromRGBO(17, 163, 199, .1),
  100: const Color.fromRGBO(17, 163, 199, .2),
  200: const Color.fromRGBO(17, 163, 199, .3),
  300: const Color.fromRGBO(17, 163, 199, .4),
  400: const Color.fromRGBO(17, 163, 199, .5),
  500: const Color.fromRGBO(17, 163, 199, .6),
  600: const Color.fromRGBO(17, 163, 199, .7),
  700: const Color.fromRGBO(17, 163, 199, .8),
  800: const Color.fromRGBO(17, 163, 199, .9),
  900: const Color.fromRGBO(17, 163, 199, 1),
};
...
ThemeData nativeTheme({bool? darkModeEnabled}) {
  ...
  if (darkModeEnabled) {
    return ThemeData(
      ...
      primaryColorLight: themeController.pickSecondaryColor,
      primarySwatch: MaterialColor(themeController.pickColorInt, color2),
      textTheme: TextTheme(
